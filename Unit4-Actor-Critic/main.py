...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        torch.save(pixelcopter_policy, "trained_model.pt")
    else:
        pixelcopter_policy = torch.load("trained_model.pt")
    ...
    repo_id = "georgysavva/Reinforce-Pixelcopter-PLE-v0"  # TODO Define your repo id {username/Reinforce-{model-id}}
    push_to_hub(
        repo_id,
